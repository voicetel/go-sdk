...
<https://github.com/voicetel/go-sdk/security/advisories/new>).
...
- The SDK pins TLS 1.2+ and reuses TLS sessions (LRU client session
  cache, 64 entries) across requests. If you supply a custom
  `*http.Client`, you are responsible for matching that posture.
...
Out of scope: vulnerabilities in `github.com/voicetel/go-sdk` caused
